 ...
 * Size: 46 px
 * Bpp: 4
 * Opts: --font C:\Users\jsens_ft8b9ud\amoled-lab\mono_watchface\fonts\src\Montserrat-Medium.ttf --size 46 --bpp 4 --format lvgl --range 0x30-0x39,0xB0 --no-compress --lv-font-name font_temp_46 -o C:\Users\jsens_ft8b9ud\amoled-lab\mono_watchface\fonts\generated\font_temp_46.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 491, .box_w = 27, .box_h = 33, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 446, .adv_w = 272, .box_w = 13, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 661, .adv_w = 422, .box_w = 25, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1074, .adv_w = 421, .box_w = 25, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1487, .adv_w = 492, .box_w = 30, .box_h = 33, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1982, .adv_w = 422, .box_w = 25, .box_h = 33, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2395, .adv_w = 454, .box_w = 26, .box_h = 33, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2824, .adv_w = 440, .box_w = 25, .box_h = 33, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3237, .adv_w = 474, .box_w = 26, .box_h = 33, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3666, .adv_w = 454, .box_w = 26, .box_h = 33, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4095, .adv_w = 308, .box_w = 16, .box_h = 15, .ofs_x = 2, .ofs_y = 18}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_temp_46 = {
#else
lv_font_t font_temp_46 = {
#endif
